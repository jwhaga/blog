...
public class WebsiteConfigVO {
    ...
    @Schema(name = "nickName", description = "网站作者昵称", requiredMode = Schema.RequiredMode.REQUIRED)
    private String englishName;

    @Schema(description = "网站作者", requiredMode = Schema.RequiredMode.REQUIRED)
    private String author;

    @Schema(name = "avatar", description = "网站头像", requiredMode = Schema.RequiredMode.REQUIRED)
    private String authorAvatar;

    @Schema(name = "description", description = "网站作者介绍", requiredMode = Schema.RequiredMode.REQUIRED)
